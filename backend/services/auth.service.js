...
function generateTokens(user) {
  ...
  return { accessToken, refreshToken, expiresIn: config.jwt.accessExpiresIn, user: { id: user.id, username: user.username, email: user.email, role: user.role } };
}
