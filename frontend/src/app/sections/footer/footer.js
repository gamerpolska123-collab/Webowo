...
class WebowoSectionFooter extends HTMLElement {
  ...
  render() {
    ...
    const brand = data.brand || t('footer_brand') || 'Matys WebDev';
    const tagline = data.tagline || t('footer_tagline') || 'Tworzenie Stron Internetowych';
    const copyright = data.copyright || t('footer_copyright') || `© ${new Date().getFullYear()} Matys WebDev`;
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        .social a { width: 40px; height: 40px; border-radius: 50%; background: var(--color-bg); display: flex; align-items: center; justify-content: center; text-decoration: none; transition: background 0.2s; color: var(--color-text); }
      ...
      <footer>
        ...
        <div class="social">
          <a href="https://github.com/gamerpolska123-collab" target="_blank" rel="noopener" aria-label="GitHub">GH</a>
          <a href="https://linkedin.com/in/patryk-matys" target="_blank" rel="noopener" aria-label="LinkedIn">LI</a>
        </div>
